...
// Deliberately NO CORS headers. Every legitimate caller (curl, the
// Telegram bridge, scripts) is server-side and unaffected. Browsers,
// however, treat a missing CORS policy as a hard deny — which is what
// keeps a random web page you visit from POSTing to 127.0.0.1:3777 and
// reaching run_command. The localhost port binding does not protect
// against your own browser; this does.
